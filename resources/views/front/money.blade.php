...
<div style="width: 100%; height: 100vh; background-color: blanchedalmond; display: flex; flex-direction: column;">
    <div class="m-auto">
        <h1>交易進行中,請稍後...</h1>
        <h2>跳轉至金流頁面中,請勿關閉網頁</h2>
    </div>
</div>

<form name='Newebpay' id="tradeform" method='post' action='https://ccore.newebpay.com/MPG/mpg_gateway' class="d-none">
    MerchantID ： <input type='text' name='MerchantID' value='MS130038639'><br>
